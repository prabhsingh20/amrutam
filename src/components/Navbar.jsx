    ...
    <nav className="flex h-20 w-full items-center justify-between bg-navbar  px-20 py-2">
      <div className="inline-flex items-center">
        ...
        <div className="flex gap-8">
          <NavLink
            to="/homepage"
            className="ml-16 text-xl font-normal text-[#474747]"
          >
            Home
          </NavLink>
          <NavLink to="/" className="text-xl font-medium text-[#3A643B]">
            Find Doctors
          </NavLink>
          <NavLink to="/aboutus" className="text-xl font-normal text-[#474747]">
            About us
          </NavLink>
        </div>
      </div>
